...
module _
  ...
  pr1 submonoid-congruence-Monoid = {!!}
  ...
  pr1 normal-submonoid-congruence-Monoid = {!!}
```
...
module _
  ...
  pr1 saturated-congruence-Normal-Submonoid = {!!}
```
