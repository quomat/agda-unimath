...
module _
  ...
  pr1 hom-inclusion-Subsemigroup = {!!}
```
...
type-Large-Preorder (Subsemigroup-Large-Preorder G) l2 = {!!}
...
preserves-order-subset-Subsemigroup G H K = {!!}
