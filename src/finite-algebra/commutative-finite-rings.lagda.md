...
module _
  ...
  finite-ring-Commutative-Ring-𝔽 = {!!}
  ...
  set-Commutative-Ring-𝔽 = {!!}

  type-Commutative-Ring-𝔽 : UU l
  type-Commutative-Ring-𝔽 = {!!}
