...
pr1 (well-ordering-principle-ℕ P d (pair zero-ℕ p)) = {!!}
pr1 (pr2 (well-ordering-principle-ℕ P d (pair zero-ℕ p))) = {!!}
pr2 (pr2 (well-ordering-principle-ℕ P d (pair zero-ℕ p))) m q = {!!}
...
is-zero-well-ordering-principle-ℕ P d (pair zero-ℕ p) p0 = {!!}
