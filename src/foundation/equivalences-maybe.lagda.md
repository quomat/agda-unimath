...
equiv-eq-maybe-structure Y .Y refl = {!!}
```
...
restrict-injective-map-Maybe' {f = f} is-inj-f x (inl y) p = {!!}
...
module _
  ...
  computation-extend-equiv-Maybe f x y p = {!!}
